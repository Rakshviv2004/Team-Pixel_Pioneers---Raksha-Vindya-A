...
export function seed() {
  ...
  const resources = [
    ...
    ["Rajwada Furniture Exchange", "Reuse", "Drop off or claim second-hand furniture — no cost, first come first served.", "Rajwada", "", null, "Anonymous", "approved", 1],
    ...
    ["Sapna Sangeeta Book Swap", "Reuse", "Bring a book, take a book — an open shelf outside the community hall.", "Sapna Sangeeta", "karan.m@gmail.com", 4, "Karan M.", "pending", 0],
